...
import welcomeImage from '../assets/WelcomeMemoji.png'; // Import your image
...
const WelcomeMessage = ({onButtonClick}) => {
  return (
    <div className="flex flex-col mx-auto items-center justify-center md:justify-normal text-white py-12 md:py-16 p-0 sm:p-4 w-full md:w-3/5 h-full">
        <img src={welcomeImage} alt="Welcome" className="mb-4 w-72 h-72 md:w-80 md:h-80 lg:w-96 lg:h-96" /> {/* Adjust the size as needed */}
